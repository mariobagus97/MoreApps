...
@implementation MNCAppsBodyCollectionCell
@synthesize delegate;
...
- (void)loadImageView
{
    ...
    [[image.heightAnchor constraintEqualToConstant:60] setActive:YES];
...
- (void)loadButtonView
{
    ...
    [[button.heightAnchor constraintEqualToConstant:30] setActive:YES];
